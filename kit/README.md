...
1. **A dataset** (videos + ground truth, on the datastore mount) — run *your* pipeline on these videos:
   ...
   |---|---|---|---|---|---|
   | `ms02` | 2 | yes (sparse) | ✓ | **AssA ≈ 0.70** *(lead with AssA — see note)* | — |
   | `ds1`  | 10 (Tc6+Tc8) | yes (dense) | ✓ | **IDF1 ≈ 0.53** *(reference config, this kit)* | 0.69 |
   | `ds2`  | 30 (Tc1–Tc8) | none | ✗ (viz only) | — | 0.49 *(leaderboard)* |
