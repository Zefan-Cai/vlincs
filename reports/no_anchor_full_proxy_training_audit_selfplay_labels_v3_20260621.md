...
{
  "alpha": 1000.0,
  "corr": -0.038264116018980956,
  "mae": 0.014333226550608359,
  "rmse": 0.06670950044443262
}
...
| feature | corr |
| --- | ---: |
| `moved_tracklets` | `-0.496437` |
| `candidate_search_prefix` | `-0.100794` |
| `tracklet_pair_recall` | `0.096216` |
| `tracklet_pair_f1` | `0.072832` |
| `preview_mean_source_quality` | `-0.066633` |
| `output_tracklets` | `0.066073` |
| `source_size` | `0.050947` |
| `max_sources_per_target` | `0.047291` |
| `preview_mean_source_score` | `0.046282` |
| `target_size` | `-0.042391` |
| `target_min_view_sim` | `-0.041225` |
| `target_quality` | `-0.041225` |
| `source_margin_mean` | `-0.041225` |
| `target_score` | `-0.041225` |
| `target_best_sim` | `-0.041225` |
| `target_mean_sim` | `-0.041225` |
| `source_quality` | `-0.041225` |
| `source_score` | `-0.041225` |
| `target_margin` | `-0.041225` |
| `preview_mean_source_size` | `0.041138` |
