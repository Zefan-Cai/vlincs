...
- summed positive bridge mass in top rows: `23021041.000`

| audit rank | candidate rank | moved | edits | predicted full | pair F1 | coverage | positive edges | impure targets | mode |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | `1` | `44.0` | `1.0` | `None` | `None` | `0.002510` | `1` | `1` | `component_graph_high_mass_bridge` |
| 2 | `2` | `77.0` | `1.0` | `None` | `None` | `0.000019` | `1` | `1` | `component_graph_high_mass_bridge` |
